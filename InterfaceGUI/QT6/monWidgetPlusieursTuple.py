...
import os
from PyQt6.QtWidgets import QFrame, QApplication, QFrame, QWidget
...
from UiQT6.Tuple2 import Ui_Tuple2
from UiQT6.Tuple3 import Ui_Tuple3
from UiQT6.Tuple4 import Ui_Tuple4
from UiQT6.Tuple5 import Ui_Tuple5
from UiQT6.Tuple6 import Ui_Tuple6
from UiQT6.Tuple7 import Ui_Tuple7
from UiQT6.Tuple8 import Ui_Tuple8
from UiQT6.Tuple9 import Ui_Tuple9
from UiQT6.Tuple10 import Ui_Tuple10
...
class MonWidgetPlusieursTuple(Feuille, GereListe):
    ...
    # ----------------------------
        ...
        if len(liste) % self.nbValeurs != 0:
            ...
            self.editor.afficheMessageQt(tr(texte), Qt.GlobalColor.red)
            return
        ...
        if not validite:
            self.editor.afficheMessageQt(comm + comm2, Qt.GlobalColor.red)
            return
