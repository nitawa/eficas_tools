...
from PyQt6.QtWidgets import QApplication, QMainWindow, QGridLayout, QHBoxLayout, QVBoxLayout, QBoxLayout, QMenu, QMessageBox
...
from UiQT6.myMain import Ui_Eficas
from InterfaceGUI.QT6.qt_editor_manager import QtEditorManager
...
class QtEficasAppli(EficasAppli, Ui_Eficas, QMainWindow):
    ...
    #----------------------------------------------------------------------------------------------------------------------------------------------
    def __init__(self, code=None, versionCode=None, salome=1, multi=False, langue="fr", ssCode=None, cataFile=None, GUIPath="InterfaceGUI.QT6", appWeb = None):
    #----------------------------------------------------------------------------------------------------------------------------------------------
        """
        Constructor
        """
        ...
        if self.maConfiguration.demandeLangue:
            from InterfaceGUI.QT6.monChoixLangue import MonChoixLangue
        ...
        if hasattr(self, "frameEntete"):
            ...
            self.blEnteteGlob = QBoxLayout(QBoxLayout.Direction.BottomToTop,self.frameEntete)
        ...
        if self.maConfiguration.boutonDsMenuBar:
            #self.blEnteteCommmande = QBoxLayout(QBoxLayout.Direction('LeftToRight'))
            self.blEnteteCommmande = QHBoxLayout()
    ...
    #-----------------------------------
        ...
        self.ssCode = ssCode
        if self.code == None:
            from InterfaceGUI.QT6.monChoixCode import MonChoixCode
    ...
    #---------------------
        ...
        if not (self.code in listePatrons.sous_menus):
            if hasattr(self, "menuPatrons"):
                self.menuPatrons.setAttribute(Qt.WidgetAttribute.WA_DeleteOnClose)
    ...
    #-------------------------
        from InterfaceGUI.QT6.gereTraduction import traduction
    ...
    def version(self):
    #----------------
        from InterfaceGUI.QT6.monVisu import DVisu
    ...
    def optionPdf(self):
    #---------------------
        from InterfaceGUI.QT6.monOptionsPdf import OptionPdf
    ...
    # a retester
        ...
        from InterfaceGUI.QT6.monLayoutBouton import MonLayoutBouton
