...
class Node(browser.JDCNode, typeNode.PopUpMenuNodeMinimal):
    ...
    def getPanelGroupe(self, parentQt, maCommande):
        ...
        if monObjet.isInformation():
            from InterfaceGUI.QT6.InterfaceGUI.QT6.monWidgetInfo import MonWidgetInfo
        ...
        if self.item.waitMatrice():
            from InterfaceGUI.QT6.monWidgetMatrice import MonWidgetMatrice
        ...
        if maDefinition.max == 1:
            ...
            if maDefinition.intoSug != [] and maDefinition.intoSug != None:
                from InterfaceGUI.QT6.monWidgetCBIntoSug import MonWidgetCBIntoSug
            ...
            # PNPNPN - a retester
                ...
                nomDuFichier = "InterfaceGUI.QT6.monWidgetSimpTupleN"
                try:
                    # if 1 :
                ...
                from InterfaceGUI.QT6.monWidgetSimpComplexe import MonWidgetSimpComplexe
                ...
                if len(self.item.getSdAvantDuBonType()) == 0:
                    from InterfaceGUI.QT6.monWidgetUniqueSDCO import MonWidgetUniqueSDCO
                    widget = MonWidgetUniqueSDCO( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                else:
                    from InterfaceGUI.QT6.monWidgetSDCOInto import MonWidgetSDCOInto
                ...
                if self.item.waitUserAssdOrAssdMultipleEnCreation():
                    from InterfaceGUI.QT6.monWidgetCreeUserAssd import MonWidgetCreeUserAssd
                    widget = MonWidgetCreeUserAssd( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                elif len(maListe) == 0:
                    from InterfaceGUI.QT6.monWidgetVide import MonWidgetVide
                    widget = MonWidgetVide( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                elif len(maListe) < 4:
                    from InterfaceGUI.QT6.monWidgetRadioButton import MonWidgetRadioButtonSD
                    widget = MonWidgetRadioButtonSD( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                elif len(maListe) < 7:
                    from InterfaceGUI.QT6.monWidget4a6RadioButton import ( MonWidget4a6RadioButtonSD,)
                    widget = MonWidget4a6RadioButtonSD( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                else:
                    from InterfaceGUI.QT6.monWidgetCB import MonWidgetCBSD
                ...
                from InterfaceGUI.QT6.monWidgetSimpSalome import MonWidgetSimpSalome
                widget = MonWidgetSimpSalome( self, maDefinition, monNom, monObjet, parentQt, maCommande)
            elif self.item.waitTxm():
                from InterfaceGUI.QT6.monWidgetSimpTxt import MonWidgetSimpTxt
        ...
        # Gestion des SIMP attendant une liste
            ...
            if maDefinition.intoSug != [] and maDefinition.intoSug != None:
                if self.item in self.editor.listeDesListesOuvertes or not (self.editor.afficheListesPliees):
                    from InterfaceGUI.QT6.monWidgetIntoSug import MonWidgetIntoSug
                    widget = MonWidgetIntoSug( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                else:
                    from InterfaceGUI.QT6.monWidgetPlusieursPlie import MonWidgetPlusieursPlie
            ...
            # Attention pas fini --> on attend une liste de ASSD avec ordre
                ...
                if len(listeAAfficher) == 0:
                    ...
                    from InterfaceGUI.QT6.monWidgetPlusieursInto import MonWidgetPlusieursInto
                ...
                if enable_salome_selection:
                    from InterfaceGUI.QT6.monWidgetPlusieursBase import MonWidgetPlusieursBase
                    ...
                    from InterfaceGUI.QT6.monWidgetPlusieursASSDIntoOrdonne import MonWidgetPlusieursASSDIntoOrdonne
                    widget = MonWidgetPlusieursASSDIntoOrdonne( self, maDefinition, monNom, monObjet, parentQt, maCommande)
                else:
                    from InterfaceGUI.QT6.monWidgetPlusieursPlie import MonWidgetPlusieursPlieASSD
                ...
                # Attention, tableau est obsolete et mal teste
                    from InterfaceGUI.QT6.monWidgetTableau import MonWidgetTableau
                    ...
                    nomDuFichier = "InterfaceGUI.QT6.monWidgetPlusieursTupleN"
                    try:
                        _temp = __import__( nomDuFichier, globals(), locals(), [nomDeLaClasse], 0)
                ...
                if self.item.isListSansOrdreNiDoublon():
                    ...
                    if self.item in self.editor.listeDesListesOuvertes or not (self.editor.afficheListesPliees):
                        from InterfaceGUI.QT6.monWidgetPlusieursIntoOrdonne import MonWidgetPlusieursIntoOrdonne
                ...
                if self.item.waitUserAssdOrAssdMultipleEnCreation():
                    from InterfaceGUI.QT6.monWidgetPlusieursCreeUserAssd import MonWidgetPlusieursCreeUserAssd
