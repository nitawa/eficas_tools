...
from PyQt6.QtWidgets import QToolButton, QWidget, QMessageBox
from PyQt6.QtGui import QFont, QFontMetrics, QFontInfo, QPalette
from PyQt6.QtCore import Qt

from Accas.extensions.eficas_translation import tr

from InterfaceGUI.QT6.gereIcones import ContientIcones
...
class Feuille(QWidget, ContientIcones, SaisieValeur, FacultatifOuOptionnel):
    ...
    def setNom(self):
        ...
        longueur = QFontMetrics(self.label.font()).horizontalAdvance(nomTraduit)
        if longueur >= nomMax:
