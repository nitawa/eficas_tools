...
class JDCEditor(Ui_editor5C, JDCEditorSsIhm, QWidget):
# -------------------------------------------------- #
    """
       Editeur de jdc 5C
    """
    ...
    #------------------------------------------------------------------------------------------------
        ...
        debug = 0
        if debug : print ('__init__ de JDCEditor5C :', appliEficas,fichier, jdc, QWParent)

        QWidget.__init__(self,None)
        self.setupUi(self)
        appliEficas.maConfiguration.withXSD=1
        JDCEditorSsIhm.__init__(self,appliEficas, fichier, jdc=jdc)
